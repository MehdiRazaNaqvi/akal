...
const TABLE_HEAD = [
  { id: 'company', label: 'Offices', alignRight: false },
  // { id: '', label: 'Name', alignRight: false },
  { id: 'salary', label: 'Salary in Naira (Millions per year)', alignRight: false },
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, salary, avatarUrl, office } = row;
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="center" sx={{ fontSize: "1.25rem" }}>{salary}</TableCell>
